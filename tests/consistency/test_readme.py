...
def test_readme_company_link_points_to_official_careers():
    readme = _readme()
    assert "https://e-infra.ro/careers" in readme, "README.md must link the NETCITY group careers page"
...
def test_readme_badges_match_repo():
    readme = _readme()
    assert "https://peviitor-scrapers.github.io/netcity-telecom-sa-python-scraper/" in readme, "README.md must link the GitHub Pages site"
