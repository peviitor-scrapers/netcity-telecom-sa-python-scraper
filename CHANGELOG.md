...
### Added
- Python scraper for the NETCITY TELECOM S.A. department on the group's applytojob board (`?department=NETCITY`).
...
- E2E `EXPECTED_MIN_JOBS` and integration tests reflect the NETCITY TELECOM department and CIF `22902080`.
