[![Oportunitati si Cariere](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/actions/workflows/automation-testing.yml)
...
[![GitHub Pages](https://img.shields.io/github/deployments/peviitor-scrapers/netcity-telecom-sa-python-scraper/github-pages?label=GitHub%20Pages)](https://peviitor-scrapers.github.io/netcity-telecom-sa-python-scraper/)

# job_seeker_ro_spider — NETCITY TELECOM Scraper

**job_seeker_ro_spider** — a scraper for NETCITY TELECOM S.A. jobs in Romania. It collects the announcements published by the [NETCITY](https://e-infra.ro/careers/) department on the group's applytojob board and publishes them to [peviitor.ro](https://peviitor.ro) through the Peviitor API.
...
The project automates the daily collection of NETCITY TELECOM jobs in Romania, keeping the peviitor.ro board up to date with the latest career opportunities.

## Features

- Extracts jobs from the NETCITY group applytojob board (`?department=NETCITY` filter)
