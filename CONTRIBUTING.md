...
```bash
git clone git@github.com:peviitor-scrapers/netcity-telecom-sa-python-scraper.git
cd netcity-telecom-sa-python-scraper
...
[peviitor-scrapers/netcity-telecom-sa-python-scraper/issues](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/issues).
