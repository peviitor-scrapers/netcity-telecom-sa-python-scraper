...
Acest proiect folosește [GitHub Issues](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/peviitor-scrapers/netcity-telecom-sa-python-scraper/issues).
...
`22902080` and the failing endpoint.
