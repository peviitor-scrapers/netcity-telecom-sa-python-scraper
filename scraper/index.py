"""
NETCITY TELECOM S.A. applytojob Scraper — derived from the ELECTROGRUP Python template.

Scrapes NETCITY job listings from the group applytojob board (electrogrup.applytojob.com) filtered by
...
def main(root=None):
    ...
    print(f"Jobs scraped from the NETCITY applytojob board: {scraped_count}")
